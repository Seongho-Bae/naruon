...
assert_strix_workflow_pr_trigger_hardened() {
	...
	assert_file_contains "$workflow_file" "openai/deepseek/deepseek-r1-0528 openai/deepseek/deepseek-v3-0324" "strix workflow configures reachable stronger-than-GPT-4.1 GitHub Models fallback models"
	assert_file_not_contains "$workflow_file" 'openai/deepseek/deepseek-r1-0528 | openai/deepseek/deepseek-v3-0324)' "strix workflow keeps DeepSeek GitHub Models restricted to fallback-only routing"
...
EOF
	...
	assert_file_contains "$output_file" "openai/deepseek/deepseek-r1-0528 openai/deepseek/deepseek-v3-0324" "fallback gives exact GitHub Models fallback list"
...
```text
strix	Run Strix (quick)	Strix fallback model 'openai/deepseek/deepseek-r1-0528' emitted provider infrastructure or failure-signal output; trying next configured fallback if available.
...
EOF
	...
	assert_file_not_contains "$output_file" "Strix report from openai/deepseek/deepseek-v3-0324" "fallback does not convert unmapped report into source finding"
