...
def _quality_checks(
    *,
    ...
    return [
        _check_thread_id_integrity(email_count, missing_thread_count),
        _check_dedupe_fingerprint(email_count, missing_fingerprint_count),
        _check_attachment_content(attachment_count, blank_attachment_count),
