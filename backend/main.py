...
from api.auth import get_auth_context, router as auth_router
...
from core.config import allowed_browser_origins, settings
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=list(allowed_browser_origins(settings.ALLOWED_BROWSER_ORIGINS)),
