...
class LocalMailAdapters:
    ...
    async def send_smtp(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        if account is None:
            return build_error_response("account_not_configured")
        if (
            ...
            return build_error_response("account_configuration_incomplete")
        ...
        try:
            ...
            return build_error_response("provider_destination_not_allowed")
        ...
        return build_error_response("provider_write_not_executed")
