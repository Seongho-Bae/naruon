...
class LocalMailAdapters:
    ...
    async def send_smtp(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        if account is None:
            return create_adapter_error("account_not_configured")
        if (
            ...
            return create_adapter_error("account_configuration_incomplete")
        ...
        try:
            ...
            return create_adapter_error("provider_destination_not_allowed")
        ...
        return create_adapter_error("provider_write_not_executed")
